...
function init() {
    ...
    myMap.geoObjects
        ...
        balloonContentHeader: '<a href = "" target="_blank">Выставочный дом One 62<br/> в Москве</a><br>' +
        ...
        // Зададим содержимое заголовка балуна.
        balloonContentHeader: '<a href = "" target="_blank">Выставочный дом Opti<br/> в Москве</a><br>' +
        '<span class="description">Общая площадь: 62 м²</span>',
        // Зададим содержимое основной части балуна.
        ...
        // Зададим содержимое заголовка балуна.
        balloonContentHeader: '<a href = "" target="_blank">Выставочный дом Alpha<br/> в Москве</a><br>' +
        '<span class="description">Общая площадь: 62 м²</span>',
        // Зададим содержимое основной части балуна.
